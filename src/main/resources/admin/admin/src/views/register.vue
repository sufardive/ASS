    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">马边特色产品销售系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="农户编号" class="input" v-if="tableName=='nonghu'">
                                <el-input v-model="ruleForm.nonghuUuidNumber" autocomplete="off" placeholder="农户编号"  />
                           </el-form-item>
                        -->
                        <el-form-item label="农户姓名" class="input" v-if="tableName=='nonghu'">
                            <el-input v-model="ruleForm.nonghuName" autocomplete="off" placeholder="农户姓名"  />
                        </el-form-item>
                        <el-form-item label="农户手机号" class="input" v-if="tableName=='nonghu'">
                            <el-input v-model="ruleForm.nonghuPhone" autocomplete="off" placeholder="农户手机号"  />
                        </el-form-item>
                        <el-form-item label="农户身份证号" class="input" v-if="tableName=='nonghu'">
                            <el-input v-model="ruleForm.nonghuIdNumber" autocomplete="off" placeholder="农户身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="nonghuPhotoFlag">
                            </el-form-item>
                            <el-form-item label="农户照片" class="input" v-if="tableName=='nonghu'">
                                    <file-upload
                                        tip="点击上传农户照片"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.nonghuPhoto?$base.url+ruleForm.nonghuPhoto:''"
                                        @change="nonghuPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="农户邮箱" class="input" v-if="tableName=='nonghu'">
                            <el-input v-model="ruleForm.nonghuEmail" autocomplete="off" placeholder="农户邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="余额" class="input" v-if="tableName=='nonghu'">
                       ...
                       <!--<el-form-item class="input" label="账户状态">
                        ...
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='nonghu'">
                        ...
                        -->
                        <!--
                            <el-form-item label="总积分" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuSumJifen" autocomplete="off" placeholder="总积分"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="现积分" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuNewJifen" autocomplete="off" placeholder="现积分"  />
                           </el-form-item>
                        -->
                       <!--<el-form-item class="input" label="会员等级">
                            <el-select style="width: 399px;height: 40px;" v-model="ruleForm.huiyuandengjiTypes" placeholder="请选择会员等级">
                                <el-option
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                nonghuPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            nonghuPhotoUploadChange(fileUrls) {
               this.ruleForm.nonghuPhoto = fileUrls;
                if(this.nonghuPhotoFlag){
                    this.nonghuPhotoFlag=false;
                }else{
                    this.nonghuPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // nonghu 中的 农户编号 判空处理
                            // if('nonghu' == this.tableName && (this.ruleForm.nonghuUuidNumber== null ||this.ruleForm.nonghuUuidNumber== "")){
                            //     this.$message.error("农户编号不能为空");
                            //     return
                            // }
                            if((!this.ruleForm.nonghuName)&& 'nonghu'==this.tableName){
                                this.$message.error('农户姓名不能为空');
                                return
                            }
                             if('nonghu' == this.tableName && this.ruleForm.nonghuPhone&&(!this.$validate.isMobile(this.ruleForm.nonghuPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.nonghuIdNumber)&& 'nonghu'==this.tableName){
                                this.$message.error('农户身份证号不能为空');
                                return
                            }
                            // nonghu 中的 农户照片 判空处理
                            // if('nonghu' == this.tableName && (this.ruleForm.nonghuPhoto== null ||this.ruleForm.nonghuPhoto== "")){
                            //     this.$message.error("农户照片不能为空");
                            //     return
                            // }
                            if('nonghu' == this.tableName && this.ruleForm.nonghuEmail&&(!this.$validate.isEmail(this.ruleForm.nonghuEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // nonghu 中的 余额 判空处理
                            // if('nonghu' == this.tableName && (this.ruleForm.newMoney== null ||this.ruleForm.newMoney== "")){
                            //     this.$message.error("余额不能为空");
                            //     return
                            // }
                            // nonghu 中的 账户状态 判空处理
                            // if('nonghu' == this.tableName && (this.ruleForm.jinyongTypes== null ||this.ruleForm.jinyongTypes== "")){
                            //     this.$message.error("账户状态不能为空");
                            //     return
                            // }
                            // nonghu 中的 创建时间 判空处理
                            // if('nonghu' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
                            ...
                            // }
                            // yonghu 中的 总积分 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuSumJifen== null ||this.ruleForm.yonghuSumJifen== "")){
                            //     this.$message.error("总积分不能为空");
                            //     return
                            // }
                            // yonghu 中的 现积分 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.yonghuNewJifen== null ||this.ruleForm.yonghuNewJifen== "")){
                            //     this.$message.error("现积分不能为空");
                            //     return
                            // }
                            // yonghu 中的 会员等级 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.huiyuandengjiTypes== null ||this.ruleForm.huiyuandengjiTypes== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/dbtutechan/img/back-img-bg.jpg);
